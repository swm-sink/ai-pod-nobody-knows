...
from src.core.state import PodcastState, update_cost, add_error, update_stage
from src.adapters.elevenlabs.provider import ElevenLabsProvider
...
class AudioConfig:
    ...
    voice_id: str = "ZF6FPAbjXT4488VcRRnw"  # Amelia - Production voice
