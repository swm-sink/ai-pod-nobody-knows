...
class TestAudioSynthesizerAgent:
    ...
    async def test_execute_synthesizes_audio(self, mock_langfuse):
        ...
        assert audio_config["voice_id"] == get_production_voice_id()  # Production voice
    ...
    async def test_voice_id_protection(self, mock_langfuse):
        ...
        assert agent.audio_config.voice_id == get_production_voice_id()  # Amelia
        assert agent.elevenlabs_config["voice_id"] == get_production_voice_id()
